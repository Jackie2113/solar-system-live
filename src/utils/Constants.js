...
export const PLANETS_DATA = [
    ...
    { 
        ...
        texture: BASE + 'textures/venus_surface.jpg', hasAtmosphere: true, atmosphereTexture: BASE + 'textures/venus_atmosphere.jpg',
    ...
    { 
        ...
        texture: BASE + 'textures/earth_day.jpg', 
    ...
    { 
        ...
        texture: BASE + 'textures/saturn.jpg', hasRings: true, ringTexture: BASE + 'textures/saturn_ring.png', ringInner: 4.5, ringOuter: 8.0,
